...
<body>
	...
	<div class="card border-primary mb-3 " style="max-width: 18rem; margin-left: 40%; margin-top: 25px;">
	...
	<table class="table table-hover" style="border: 0;">
		...
		<c:forEach items="${requestScope.listFlight}" var="flight">
			<tr>
				...
				<td><c:out value="${flight.getPilotCount()}"></c:out></td>
				<td><c:out value="${flight.getAirCount()}"></c:out></td>
				<td><c:out value="${flight.getGroundCount()}"></c:out></td>
			</tr>
		</c:forEach>
	</table>
